...
package modulo6.casting;

class A{void metodo(){System.out.println("a");}}
class B{void metodo(){System.out.println("b");}}
class C extends A{void metodo(){System.out.println("c");}void metodo2(){System.out.println("c2");}}
...
public class Casting{
	...
	//Parte 2:
		a=(C)e;
		//a=(E)c;//ClassCastException porque se quiere acoplar el padre al hijo
		//e=(C)e;
		a=(A)(C)e;
		a.metodo();
		a=(C)e;
