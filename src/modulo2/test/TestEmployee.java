...
import static modulo2.employee.Country.*;
...
public class TestEmployee {
    ...
    public static void main(String[] args) {
        //Estos son antes de crear el enum en Country
        ...
        //Sin el import static modulo2.employee.Country.*;
        //Location lArgentina = new Location("12-98 Victoria street", 2901, "Sidney", "New South Wales", Country.ARGENTINA);
        //Location lAustralia = new Location("20 Rue des Corps-Saints", 1730, "Geneva", "Geneve", Country.AUSTRALIA);
        ...
        //invoice.Invoice invocice = new Invoice(1, "monthly salary", e3.getSalary(), 1);
